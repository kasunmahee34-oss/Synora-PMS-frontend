...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { name: 'Pos View', href: 'https://synora-pos-frontend-production.up.railway.app/outlets/1', icon: Briefcase, external: true, roles: ['admin', 'front_office', 'cashier'], permission: 'reservations.view' },
  ];
